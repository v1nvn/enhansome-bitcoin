...
[![Awesome](https://cdn.rawgit.com/sindresorhus/awesome/d7305f38d29fed78fa85652e3a63e154dd8e8829/media/badge.svg)](https://github.com/sindresorhus/awesome) ⭐ 449,693 | 🐛 88 | 📅 2026-03-09
...
* [`<qr-code>`](https://github.com/bitjson/qr-code) ⭐ 1,376 | 🐛 14 | 🌐 TypeScript | 📅 2023-02-28 – A no-framework, no-dependencies, customizable, animate-able, SVG-based `<qr-code>` web component.
...
* [PaperVault](https://github.com/boazeb/papervault) ⭐ 14 | 🐛 0 | 🌐 JavaScript | 📅 2026-03-22 - Offline paper-based secret storage using AES-256-GCM and Shamir's Secret Sharing. Create printable encrypted backups of seed phrases with threshold key splitting.
* [Bitcoin Serverless Donations](https://github.com/tombennet/bitcoin-serverless-donations) ⭐ 4 | 🐛 0 | 🌐 JavaScript | 📅 2026-03-15 - Self-custodial serverless donation widget with address rotation derived from an XPUB.
...
* [Joinmarket](https://github.com/JoinMarket-Org/joinmarket-clientserver) ⭐ 823 | 🐛 226 | 🌐 Python | 📅 2026-03-28 - Decentralized CoinJoin implementation
...
* [UltrafastSecp256k1](https://github.com/shrec/UltrafastSecp256k1) ⭐ 23 | 🐛 5 | 🌐 C++ | 📅 2026-03-29 - High-performance `secp256k1` engine with a stable C ABI, CPU, CUDA, OpenCL, embedded, and WebAssembly targets.
...
* [Bitcore Library](https://github.com/bitpay/bitcore/tree/v8.0.0/packages/bitcore-lib) ⭐ 4,986 | 🐛 41 | 🌐 TypeScript | 📅 2026-03-27
...
* [noble-curves](https://github.com/paulmillr/noble-curves) ⭐ 891 | 🐛 6 | 🌐 TypeScript | 📅 2026-03-23 — audited implementation of secp256k1 + schnorr in pure typescript
* [noble-secp256k1](https://github.com/paulmillr/noble-secp256k1) ⭐ 867 | 🐛 1 | 🌐 TypeScript | 📅 2026-03-23 — alternative implementation of secp256k1: size is only 4KB gzipped; lots of comments, very valuable for learning how algorithms work
...
* [Rust Bitcoin](https://github.com/rust-bitcoin/rust-bitcoin) ⭐ 2,609 | 🐛 488 | 🌐 Rust | 📅 2026-03-29 - support for de/serialization, parsing and executing on data-structures and network messages.
...
* [pybtc](https://github.com/mohanson/pybtc) ⭐ 13 | 🐛 0 | 🌐 Python | 📅 2026-03-27 - Python BTC is an experimental project that aims to provide human-friendly interfaces for common BTC operations.
...
* [XChange](https://github.com/knowm/XChange) ⭐ 4,049 | 🐛 346 | 🌐 Java | 📅 2026-02-26 - Library that provides a simple and consistent API for interacting with 50+ Bitcoin currency exchanges.
...
* [secp256k1.swift](https://github.com/GigaBitcoin/secp256k1.swift) ⭐ 149 | 🐛 2 | 🌐 Swift | 📅 2026-03-27 - Swift package for secp256k1 applications, includes Elliptic Curve operations, Schnorr, ZKP and more for Bitcoin.

## .Net Libraries

* [NBitcoin](https://github.com/MetacoSA/NBitcoin) ⭐ 1,944 | 🐛 121 | 🌐 C# | 📅 2026-02-20 - Comprehensive Bitcoin library for the .NET framework.
...
* [blockchain-demo](https://github.com/anders94/blockchain-demo/) ⭐ 5,654 | 🐛 11 | 🌐 Pug | 📅 2026-02-14 - A web-based demonstration of blockchain concepts.
...
* [btcd](https://github.com/btcsuite/btcd/) ⭐ 6,682 | 🐛 336 | 🌐 Go | 📅 2026-03-25 - Go-based full node since 2013.
* [Bitcore](https://github.com/bitpay/bitcore) ⭐ 4,986 | 🐛 41 | 🌐 TypeScript | 📅 2026-03-27 - Formerly just a Nodejs library, now a full node.
...
* [Mastering Bitcoin](https://github.com/bitcoinbook/bitcoinbook) ⭐ 25,163 | 🐛 192 | 🌐 HTML | 📅 2024-12-26
