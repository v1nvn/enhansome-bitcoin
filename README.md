...
* [BTC Tooling](https://github.com/douvy/btc-tooling) ⭐ 32 | 🐛 0 | 🌐 TypeScript | 📅 2026-02-11 - Bitcoin dashboard with real-time price data, a chart, orderbook, market summary, Twitter/X insights, and halving countdown data. [Live Demo](https://www.btctooling.com/)
...
* [libsecp256k1](https://github.com/bitcoin-core/secp256k1) ⭐ 2,400 | 🐛 167 | 🌐 C | 📅 2026-02-04
...
* [Bitcore Library](https://github.com/bitpay/bitcore/tree/v8.0.0/packages/bitcore-lib) ⭐ 4,985 | 🐛 39 | 🌐 TypeScript | 📅 2026-02-11
...
* [Rust Bitcoin](https://github.com/rust-bitcoin/rust-bitcoin) ⭐ 2,562 | 🐛 539 | 🌐 Rust | 📅 2026-02-12 - support for de/serialization, parsing and executing on data-structures and network messages.
* [Bithoven](https://github.com/ChrisCho-H/bithoven) ⭐ 39 | 🐛 5 | 🌐 Rust | 📅 2026-01-06 -  A High-Level, Imperative Language for Bitcoin Smart Contracts, featuring an LR(1) parser with static analysis for compile-time safety.
...
* [secp256k1.swift](https://github.com/GigaBitcoin/secp256k1.swift) ⭐ 148 | 🐛 2 | 🌐 Swift | 📅 2026-02-11 - Swift package for secp256k1 applications, includes Elliptic Curve operations, Schnorr, ZKP and more for Bitcoin.
...
* [btcd](https://github.com/btcsuite/btcd/) ⭐ 6,667 | 🐛 317 | 🌐 Go | 📅 2026-01-13 - Go-based full node since 2013.
* [Bitcore](https://github.com/bitpay/bitcore) ⭐ 4,985 | 🐛 39 | 🌐 TypeScript | 📅 2026-02-11 - Formerly just a Nodejs library, now a full node.
