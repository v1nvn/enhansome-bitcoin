...
[![Awesome](https://cdn.rawgit.com/sindresorhus/awesome/d7305f38d29fed78fa85652e3a63e154dd8e8829/media/badge.svg)](https://github.com/sindresorhus/awesome) ⭐ 450,303 | 🐛 88 | 📅 2026-03-09
...
* [Pycoin](https://github.com/richardkiss/pycoin) ⭐ 1,440 | 🐛 54 | 🌐 Python | 📅 2026-03-01 - Python-based Bitcoin and alt-coin utility library.
* [`<qr-code>`](https://github.com/bitjson/qr-code) ⭐ 1,375 | 🐛 14 | 🌐 TypeScript | 📅 2023-02-28 – A no-framework, no-dependencies, customizable, animate-able, SVG-based `<qr-code>` web component.
* [bx](https://github.com/libbitcoin/libbitcoin-explorer) ⭐ 634 | 🐛 20 | 🌐 C++ | 📅 2024-03-01 - Bitcoin Command Line Tool.
* [Nigiri](https://github.com/vulpemventures/nigiri/) ⭐ 328 | 🐛 44 | 🌐 Go | 📅 2026-03-23 - CLI to quickly fire up a a Bitcoin regtest box along with Electrs and Esplora. Includes faucet and push commands.
* [hellobitcoin](https://github.com/prettymuchbryce/hellobitcoin) ⭐ 256 | 🐛 2 | 🌐 Go | 📅 2017-03-22 - A collection of simple programs which can generate bitcoin wallets, create and sign transactions, and send transactions over the bitcoin network.
* [hal](https://github.com/stevenroose/hal) ⭐ 213 | 🐛 10 | 🌐 Rust | 📅 2026-03-12 - Bitcoin CLI swiss-army-knife (based on rust-bitcoin).
...
* [BTC Tooling](https://github.com/douvy/btc-tooling) ⭐ 33 | 🐛 0 | 🌐 TypeScript | 📅 2026-02-12 - Bitcoin dashboard with real-time price data, a chart, orderbook, market summary, Twitter/X insights, and halving countdown data. [Live Demo](https://www.btctooling.com/)
* [PaperVault](https://github.com/boazeb/papervault) ⭐ 15 | 🐛 0 | 🌐 JavaScript | 📅 2026-03-22 - Offline paper-based secret storage using AES-256-GCM and Shamir's Secret Sharing. Create printable encrypted backups of seed phrases with threshold key splitting.
* [Bitcoin Serverless Donations](https://github.com/tombennet/bitcoin-serverless-donations) ⭐ 4 | 🐛 0 | 🌐 JavaScript | 📅 2026-03-30 - Self-custodial serverless donation widget with address rotation derived from an XPUB.
...
* [Esplora](https://github.com/Blockstream/esplora) ⭐ 1,219 | 🐛 184 | 🌐 JavaScript | 📅 2026-02-04 - Self-hosted blockchain explorer.
* [One-Time Address](https://github.com/alexk111/One-Time-Address) ⭐ 83 | 🐛 7 | 🌐 Handlebars | 📅 2022-12-11 A better way to share your Bitcoin address.
...
* [Joinmarket](https://github.com/JoinMarket-Org/joinmarket-clientserver) ⭐ 822 | 🐛 226 | 🌐 Python | 📅 2026-03-28 - Decentralized CoinJoin implementation
...
* [Bitcoin Transaction Explorer](https://github.com/JornC/bitcoin-transaction-explorer) ⭐ 181 | 🐛 15 | 🌐 Java | 📅 2026-01-16
...
* [libsecp256k1](https://github.com/bitcoin-core/secp256k1) ⭐ 2,413 | 🐛 164 | 🌐 C | 📅 2026-03-26
* [UltrafastSecp256k1](https://github.com/shrec/UltrafastSecp256k1) ⭐ 23 | 🐛 5 | 🌐 C++ | 📅 2026-03-30 - High-performance `secp256k1` engine with a stable C ABI, CPU, CUDA, OpenCL, embedded, and WebAssembly targets.

## C++ Libraries

* [Libbitcoin](https://libbitcoin.info/)
* [libwally-core](https://github.com/ElementsProject/libwally-core) ⭐ 303 | 🐛 30 | 🌐 C | 📅 2026-03-19

## JavaScript Libraries

* [Bitcoinjs-lib](https://github.com/bitcoinjs/bitcoinjs-lib) ⭐ 5,981 | 🐛 41 | 🌐 JavaScript | 📅 2026-02-17
* [Bitcore Library](https://github.com/bitpay/bitcore/tree/v8.0.0/packages/bitcore-lib) ⭐ 4,986 | 🐛 38 | 🌐 TypeScript | 📅 2026-03-30
* [bcoin](https://github.com/bcoin-org/bcoin) ⭐ 3,069 | 🐛 202 | 🌐 JavaScript | 📅 2024-02-12 - Javascript bitcoin library for node.js and browsers.
* [noble-curves](https://github.com/paulmillr/noble-curves) ⭐ 892 | 🐛 6 | 🌐 TypeScript | 📅 2026-03-23 — audited implementation of secp256k1 + schnorr in pure typescript
* [noble-secp256k1](https://github.com/paulmillr/noble-secp256k1) ⭐ 868 | 🐛 1 | 🌐 TypeScript | 📅 2026-03-23 — alternative implementation of secp256k1: size is only 4KB gzipped; lots of comments, very valuable for learning how algorithms work
* [scure-btc-signer](https://github.com/paulmillr/scure-btc-signer) ⭐ 236 | 🐛 12 | 🌐 TypeScript | 📅 2026-03-23 — audited & minimal library for creating, signing & decoding Bitcoin transactions. With Schnorr, Taproot, UTXO & PSBT.
* [Awesome CryptoCoinJS](https://github.com/cryptocoinjs/awesome-cryptocoinjs) ⭐ 62 | 🐛 0 | 📅 2016-02-17
...
* [Bitcoin-ruby](https://github.com/lian/bitcoin-ruby) ⭐ 925 | 🐛 39 | 🌐 Ruby | 📅 2024-08-19
* [bitcoinrb](https://github.com/chaintope/bitcoinrb) ⭐ 67 | 🐛 1 | 🌐 Ruby | 📅 2026-03-19 - Ruby bitcoin library including script interpreter.
* [bech32rb](https://github.com/azuchi/bech32rb) ⭐ 22 | 🐛 1 | 🌐 Ruby | 📅 2026-01-21 - Bech32 and Bech32m encode/decode library.
* [bip-schnorrrb](https://github.com/chaintope/bip-schnorrrb) ⭐ 8 | 🐛 0 | 🌐 Ruby | 📅 2025-12-30 - Schnorr signature library for Bitcoin.

## Rust Libraries

* [Rust Bitcoin](https://github.com/rust-bitcoin/rust-bitcoin) ⭐ 2,608 | 🐛 488 | 🌐 Rust | 📅 2026-03-31 - support for de/serialization, parsing and executing on data-structures and network messages.
* [Bithoven](https://github.com/ChrisCho-H/bithoven) ⭐ 42 | 🐛 5 | 🌐 Rust | 📅 2026-02-25 -  A High-Level, Imperative Language for Bitcoin Smart Contracts, featuring an LR(1) parser with static analysis for compile-time safety.
...
* [pycoin](https://github.com/richardkiss/pycoin) ⭐ 1,440 | 🐛 54 | 🌐 Python | 📅 2026-03-01 - Python library for Bitcoin keys, signatures, transactions. Includes full VM implementation and tools for manipulating keys (ku) and transactions (tx).
* [pybitcointools](https://github.com/vbuterin/pybitcointools) ⭐ 1,334 | 🐛 90 | 📅 2024-07-03 - Python library for Bitcoin signatures and transactions from Vitalik Buterin. Project discontinued.
...
* [pybtc](https://github.com/mohanson/pybtc) ⭐ 13 | 🐛 0 | 🌐 Python | 📅 2026-03-31 - Python BTC is an experimental project that aims to provide human-friendly interfaces for common BTC operations.
...
* [XChange](https://github.com/knowm/XChange) ⭐ 4,050 | 🐛 347 | 🌐 Java | 📅 2026-02-26 - Library that provides a simple and consistent API for interacting with 50+ Bitcoin currency exchanges.
* [Bitcoin Spring Boot Starter](https://github.com/theborakompanioni/bitcoin-spring-boot-starter) ⭐ 80 | 🐛 16 | 🌐 Java | 📅 2026-03-01 - Bitcoin integration for Spring Boot applications.
...
* [secp256k1.swift](https://github.com/GigaBitcoin/secp256k1.swift) ⭐ 149 | 🐛 2 | 🌐 Swift | 📅 2026-03-30 - Swift package for secp256k1 applications, includes Elliptic Curve operations, Schnorr, ZKP and more for Bitcoin.

## .Net Libraries

* [NBitcoin](https://github.com/MetacoSA/NBitcoin) ⭐ 1,945 | 🐛 121 | 🌐 C# | 📅 2026-02-20 - Comprehensive Bitcoin library for the .NET framework.
* [BitcoinLib](https://github.com/cryptean/bitcoinlib) ⭐ 415 | 🐛 11 | 🌐 C# | 📅 2022-12-08 - The most complete, up-to-date, battle-tested .net Library and RPC Wrapper for Bitcoin and Altcoins in C#.

## Haskell Libraries

* [Haskoin-core](https://github.com/haskoin/haskoin-core) ⭐ 533 | 🐛 1 | 🌐 Haskell | 📅 2025-12-06 - Haskoin Core is a library of Bitcoin and Bitcoin Cash functions written in Haskell.

## Playgrounds

* [blockchain-demo](https://github.com/anders94/blockchain-demo/) ⭐ 5,653 | 🐛 12 | 🌐 Pug | 📅 2026-03-30 - A web-based demonstration of blockchain concepts.
* [Bitcoin IDE](https://github.com/siminchen/bitcoinIDE) ⭐ 221 | 🐛 16 | 🌐 JavaScript | 📅 2019-10-30 - Bitcoin Script for dummies.
* [Bitcoin Script Debugger](https://github.com/liuhongchao/bitcoin4s) ⭐ 59 | 🐛 4 | 🌐 Scala | 📅 2023-11-29 - Visualize Bitcoin script execution for real transactions.
...
* [BitcoinABE](https://github.com/bitcoin-abe/bitcoin-abe) ⭐ 980 | 🐛 159 | 🌐 Python | 📅 2023-06-26 - Abe: block browser for Bitcoin and similar currencies.
...
* [Chaingraph](https://github.com/bitauth/chaingraph/) ⭐ 59 | 🐛 61 | 🌐 TypeScript | 📅 2025-11-16 – A multi-node blockchain indexer and GraphQL API.

## Full nodes

* [btcd](https://github.com/btcsuite/btcd/) ⭐ 6,681 | 🐛 337 | 🌐 Go | 📅 2026-03-25 - Go-based full node since 2013.
* [Bitcore](https://github.com/bitpay/bitcore) ⭐ 4,986 | 🐛 38 | 🌐 TypeScript | 📅 2026-03-30 - Formerly just a Nodejs library, now a full node.
...
* [Mastering Bitcoin](https://github.com/bitcoinbook/bitcoinbook) ⭐ 25,165 | 🐛 192 | 🌐 HTML | 📅 2024-12-26
...
* [Lightning Network Protocol Development Curriculum - Chaincode Labs](https://github.com/chaincodelabs/lightning-curriculum) ⭐ 376 | 🐛 0 | 📅 2023-12-07.
...
Inspired by the [awesome](https://github.com/sindresorhus/awesome) ⭐ 450,303 | 🐛 88 | 📅 2026-03-09 list thing.
